...
_SP3_S_BCP_DICT = {'S1-N3': {'xyz': np.array([ 0.41409652, -0.40317651,  0.97579674]),
  'rho': [0.29061950428],
 ...
 'S1-C6': {'xyz': np.array([0.29635447, 1.79135009, 0.00210556]),
  'rho': [0.21337516588],
  ...
  'G': [0.047805675864],
  'H': [-0.159821998876]},
 'S1-O5': {'xyz': np.array([ 0.27136246, -0.43072436, -0.95096459]),
  'rho': [0.29999597907],
...
_SP3_GE_BCP_DICT = {'Ge1-H3': {'xyz': np.array([0.63285749, 1.58759917, 0.00208131]),
  'rho': [0.13950861934],
  ...
  'G': [0.093748195763],
  'H': [-0.092685357287]},
 'Ge1-F8': {'xyz': np.array([ 0.41813183, -0.61659892, -1.38436273]),
  'rho': [0.14029849101],
 ...
 'C4-Ge1': {'xyz': np.array([ 0.69530554, -1.02534523,  1.22952605]),
  'rho': [0.13510538184],
